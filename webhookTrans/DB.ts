...
export default class SharedDB {
     ...
     * @returns
     */
    AddSessionLogInReports = async (UserSessionID: string, ConsultantCode: string, CustomerName: string, AnswerStatus: string,
        VehicleModelCode: string, AppName: string, Confidence: Number, UserQuery: string, BotAnswer: string,
        EmailID: string, FeatureActionName: string, IsFallBack: string, source: string) => {
    ...
    /**
         ...
         * @returns
         */
    SaveBOTLeads = async (Name: string, Mobileno: string, emailID: string, Action: string,Platform:string) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
     ...
     * @returns
     */
    AddSkillTrack = async (UserSessionID: string, skillname: string, step: string,
        response: string, google_response: string, stepno: number) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
                    .input('UserSessionID', sql.VarChar(255), UserSessionID)
     ...
     * @returns
     */
    AddAPITrack = async (CustomerName: string, skillname: string, SessionID: string,
        MobileNo: string, EmailID: string, Response: string, Otherdetails: string) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
     ...
     * @returns
     */
    SaveCustomerDetails = async (Name: string, Mobileno: string, emailID: string, IsGAUser: boolean) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
     ...
     * @returns
     */
    UpdateCustomerDetails = async (Mobileno: string, emailID: string) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
                    .input('Mobileno', sql.VarChar(20), Mobileno)
     ...
     * @returns
     */
    Get_UserSessionDataOnSessionID = async (SessionID: string) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
     ...
     * @returns
     */
    getNonTechnicalDetails = async (actionname) => {
        return new Promise((resolve, reject) => {
     ...
     * @returns
     */
    chkVehicleActiveorNot = async (vehiclename) => {
        return new Promise((resolve, reject) => {
            syouv_poolPromise.then(pool => {
...
export class PriceDB {
     ...
     * @returns
     */
    ModelSpecificSpeechURL = async (FetureName, VariantName, vehicle) => {
        return new Promise((resolve, reject) => {
            syouv_poolPromise.then(pool => {
                pool.request()
...
*/
export class TestdriveDBHelper {
    constructor() {
    }
...
*/
export class VehicleAvailabilityDBHelper {
    constructor() {
    }
...
*/
export class DealerLocatorDBHelper {
    constructor() { }
...
*/
export class RMContactDetailsDBHelper {
 ...
 * RM Contact DB helper class 
*/
export class FaqDetailsDBHelper {
...
*/
export class ServiceBookingDBHelper {
    constructor() { }
     ...
     * @returns
     */
    GetDealersForCityByModel = async (city, modelGroup) => {
        return new Promise((resolve, reject) => {
     ...
     * @returns
     */
    GetNearbyDealersByLatlng = async (modelGroup, lat, lng) => {
...
export class MTBDDB{
    ...
    AddMTBDLog = async (name: string, MobileNo: string, City: string, TransportCompany: string,
        FleetStrength: string, Category: string, SubCategory: string, Model: string, Purpose: string,
        PurchasePeriod: string,profile:string) => {
        return new Promise((resolve, reject) => {
            reports_poolPromise.then(pool => {
                pool.request()
                    .input('name', sql.VarChar(255), name)
