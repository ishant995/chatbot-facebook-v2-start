...
export default class Constant {
    static TD_BASE_URL = process.env.TD_BASE_URL
    static PRESALES_BASE_URL = process.env.PRESALES_BASE_URL
    static LMS_BASE_URL = process.env.LMS_BASE_URL
    static OCP_SUBSCRIPTION_KEY = process.env.OCP_SUBSCRIPTION_KEY

    static WYH_BASE_URL = process.env.WYH_BASE_URL
    static WYH_BASE_URL_TEMP = process.env.WYH_BASE_URL_TEMP
    ...
    static WYH_METHODS = {
        ...
        GET_VEHICLE_BY_CHASSIS_OR_REGISTRATION: '/getVehicleByChassisOrReg', //DMS
        CHECK_DEALER_HOLIDAY: '/checkDealerHoliday',//DMS
        GET_RO_BILL_LIST: '/getROBillList',//DMS
        GET_RO_BILL_LIST_SINGLE_RO: '/getROBillListForSingleRO',//DMS
        GET_SERVICE_KM_LIST: '/getServiceCalculatorKmList',//DMS
        GET_SERVICE_CALCULATOR: '/getServiceCalculator',//DMS
        GET_VEHICLE_SERVICE_REMINDER: '/getVehicleServiceReminder',//DMS
        GET_RSA_SCHEMES: '/getRSASchemeDetails',//DMS
        GET_SHIELD_SCHEMES: '/getShieldSchemeDetails',//DMS
    ...
    static WYH_MSG91_API = 'https://control.msg91.com/api/sendhttp.php'
    ...
    static SERVICEBOOKINGCONSTANT = {
        SPECIFICATION: "servicebooking"
    }
    static SERVICE_BOOKING_STATUS_CONSTANT = "servicebookingstatus"
    ...
    static continueOptionswyhwhatsapp = [
        `👉 Service Booking`,
        `👉 Service History`,
    ...
    static ENC_KEY = '-----BEGIN PUBLIC KEY-----\n' +
    ...
    static ENC_KEY_PRIVATE = '-----BEGIN PRIVATE KEY-----\n' +
    ...
    static DF_GOOGLE_CLIENT_ACCESS_ID = process.env.DF_GOOGLE_CLIENT_ACCESS_ID
    ...
    static Infobip={
        ...
        WELCOME_CONTEXT: 'welcomecontext',
        */
        BASE_URL: process.env.WHATSAPP_BASE_URL,//"https://ejj1y3.api.infobip.com/omni/1/advanced",
        SCENARIO_KEY:process.env.WHATSAPP_SENARIO_KEY,//"0ECC41A2EE8094B6A8D9790748DC5972",
        AUTH_KEY: process.env.WHATSAPP_AUTH_KEY,//''"aGFtZXNoYV9QT0M6QXBzdWNoQDE=",
        FROM_MOBILENO: process.env.WHATSAPP_FROM_MOBILENO,//"447491163530",
        X_AGENTID:process.env.WHATSAPP_X_AGENTID,// "5A3820C64BF2BE56054B29B7E5622921",
        WELCOME_CONTEXT: 'welcomecontext',
